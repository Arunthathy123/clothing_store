  ...
  return (
    <div className="p-10 bg-blue-100">
      <div className="text-left mb-24 flex flex-col gap-2">
        ...
        <h1 data-aos="fade-up" className="text-3xl text-gray-800 font-bold">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-28 place-items-center">
        {products.map((product) => (
          <div
            key={product.id}
            data-aos="zoom-in"
            className="rounded-2xl bg-gray-100 hover:bg-gray-900 hover:text-white relative shadow-xl duration-300 group max-w-[300px]"
          >
            ...
            <div className="p-4 text-center mt-6">
              ...
              <h1 className="text-xl font-bold mb-2 group-hover:text-white text-gray-900">{product.title}</h1>
              <p className="text-gray-500 group-hover:text-white text-sm line-clamp-2">
                {product.description}
              </p>

              <Button
                className="mb-4 bg-blue-950 hover:scale-105 duration-300 text-white hover:text-gray-500 py-1 px-4 rounded-full mt-6 group-hover:bg-white group-hover:text-gray-950"
